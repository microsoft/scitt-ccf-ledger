  ...
  "actions": [
    {
      ...
      "args": {
        "configuration": {
          "policy": {
            "policyScript": "export function apply(phdr) { if (!phdr.cwt || !phdr.cwt.iss) {return 'Issuer not found'} if (phdr.cwt.iss !== 'did:x509:0:sha256:HnwZ4lezuxq/GVcl/Sk7YWW170qAD0DZBLXilXet0jg=::eku:1.3.6.1.4.1.311.10.3.13') { return 'Invalid issuer'; } }"
          },
          "authentication": {

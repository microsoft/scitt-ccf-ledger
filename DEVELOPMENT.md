...
2. Install dependencies:
    ```sh
    wget https://github.com/microsoft/CCF/archive/refs/tags/ccf-4.0.16.tar.gz
    tar xvzf ccf-4.0.16.tar.gz
    cd CCF-ccf-4.0.16/getting_started/setup_vm/
    ./run.sh app-dev.yml -e ccf_ver=4.0.16 -e platform=<sgx|virtual> -e clang_version=<11|15>
    ```

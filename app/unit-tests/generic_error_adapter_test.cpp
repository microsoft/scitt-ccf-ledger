...
namespace
{
    ...
    public:
        ...
        MOCK_METHOD(void, set_response_header, (const std::string&, const std::string&));
    ...
    {
    public:
        std::shared_ptr<MockRpcContext> rpc_ctx = std::make_shared<MockRpcContext>();
    };
    ...
    {
        auto adapted_function = generic_error_adapter<EndpointFunction, MockContext>(test_function);
